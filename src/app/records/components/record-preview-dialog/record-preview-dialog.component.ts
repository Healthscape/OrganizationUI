...
export class RecordPreviewDialogComponent {
    ...
    constructor(private accessRequestService: AccessRequestService, private _snackBar: MatSnackBar, private dialogRef: MatDialogRef<RecordPreviewDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: {
        record: RecordOverviewDto
