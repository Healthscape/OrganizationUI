...
export class RequestDialogComponent {
    ...
    constructor(private tokenService: TokenService, private dialogRef: MatDialogRef<RequestDialogComponent>, private accessRequestService: AccessRequestService, @Inject(MAT_DIALOG_DATA) public data: {
